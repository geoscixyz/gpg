...
In this chapter we will give a brief introduction to seismic refraction surveying, focusing on near-surface investigations. We will use the ray path model to examine how refracted waves appear in seismic data. We will consider how rays travel in layered media and examine some the variations that occur with more complex geometries such as dipping layers.
