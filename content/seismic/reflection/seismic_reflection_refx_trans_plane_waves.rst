...
We define here the "Acoustic Impedance" \\( Z = \\rho V \\), or the product of
...
3. If   \\( Z_2 >> Z_1 \\)   \\( R = 1 \\),  \\( T = 0 \\) (air earth
...
energy is \\( E_R \\) and the ration of incoming to transmitted energy is \\(
