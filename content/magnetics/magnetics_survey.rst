...
(a) the total magnetic field |B|. 
(b) an individual component of B, such as Bx, By or Bz
(c) a gradient of the magnetic field

Of the above choices, by far the most common is the measurement of the total 
magnetic field. However, the same principles of survey design dicussed below apply to 
...
Student Exercise:
Experiment with burying a prism. Place the object at different depths and assess what your estimates of survey area and sampling interval should be. In preparation for a future exercise, look at the relationship between the halfwidth of the anomaly and the depth of burial.  
