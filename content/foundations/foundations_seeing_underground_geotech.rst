...
Interpretation of a precise depth for the interface between conductive material and bedrock would be greatly aided by a single borehole drilled to a depth of roughly 50 metres anywhere within the high conductivity region. This would also help to identify the value of conductivity at which the physical interface should be interpreted. 
